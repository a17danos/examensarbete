% One example of how JavaScript and WebAssembly could complement each other is to port selected portions of a popular framework or web app for improved performance without changing it's interface.
