...
%The problem is to know in which cases WebAssembly provides a significant performance improvement and in which browsers?
...
% Jag tänker ännu lite mera specifikt, att frågan kan vara att ta reda på i vilka fall som man får prestandavinst. Problemet är att det är svårt att veta vilka algoritmer som är lämpliga för att utvärdera detta. Artefakten kan då bestå av algoritmerna som gör webb-applikations-relevanta saker för att se vilka av dem som är bättre i vilken plattform.
